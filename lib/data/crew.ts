...
export const crewInformation: CrewInfo[] = [
  {
    ...
    downloadUrl: "/assets/files/pdf/Saga Lundenwic 2025 - Stages, Info.pdf",
  },
  {
    name: "Packing List",
...
export const crewRoles: CrewInfo[] = [
  {
    ...
    downloadUrl: "/assets/files/pdf/Captain - Role description.pdf",
  },
  {
    name: "Chef",
    ...
    downloadUrl: "/assets/files/pdf/Chef - Role description.pdf",
  },
  {
    name: "Chief Engineer",
    ...
    downloadUrl: "/assets/files/pdf/Chief Engineer - Role description.pdf",
  },
  {
    ...
    downloadUrl: "/assets/files/pdf/Media responsible - Role description.pdf",
  },
  {
    ...
    downloadUrl: "/assets/files/pdf/Stage Responsible HOME - Role description.pdf",
  },
  {
    ...
    downloadUrl: "/assets/files/pdf/Stage Responsible ON BOARD - Role description.pdf",
  },
];